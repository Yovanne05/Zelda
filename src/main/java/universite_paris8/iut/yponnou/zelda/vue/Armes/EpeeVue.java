...
public class EpeeVue extends ObjetVue {
    ...
    private final javafx.scene.image.Image sword32x32 = new javafx.scene.image.Image("file:src/main/resources/universite_paris8/iut/yponnou/zelda/Images/armes/sword.png");
